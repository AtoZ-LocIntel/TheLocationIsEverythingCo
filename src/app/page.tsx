...
export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-r from-orange-400 via-amber-300 to-yellow-400
text-white">
      {/* Nav Bar */}
      <header className="flex items-center justify-between px-8 py-4 bg-black/70 shadow-lg">
        <div className="flex items-center gap-2">
          <Image src="/logo.png" alt="The Location Is Everything Co" width={192} height={96} className="w-48 h-auto" priority />
          <span className="text-2l font-bold tracking-tight">Location is Everything!</span>
        </div>
      ...
      <section className="flex flex-col items-center justify-center text-center py-10 md:py-16 px-4">
       <h1 className={`${barlowCondensed.className} text-4xl md:text-6xl font-extrabold italic mb-4 bg-gradient-to-r from-blue-400 via-cyan-400 to-emerald-400
 bg-clip-text text-transparent tracking-tight leading-[1.2] overflow-visible`}>
  Location Intelligence <span className="block md:inline">On Your Terms</span>
</h1>

        <p className="text-xl md:text-2xl font-light mb-4 max-w-2xl">
        ...
        <p className="text-base md:text-lg text-gray-200 mb-8 max-w-2xl">
          Get affordable full-featured location tools and data, built on open standards—accessible via the web, without the vendor commitment.
        </p>
      </section>
